  ...
  return (
    <section className={styles.homePage} data-testid="homepage-content">
      ...
      <p className={styles.paragraph}>
        ...
        similique maxime, nostrum natus. Eaque minima voluptas voluptatum
        possimus necessitatibus laborum quibusdam voluptatibus maiores ipsum
      ...
      <p className={styles.paragraph}>
        ...
        omnis culpa labore quam? Tempore quaerat distinctio repudiandae
        reprehenderit corporis exercitationem ratione sit, aliquam excepturi
        nostrum laborum a ex optio inventore eum unde nulla, molestias rerum est
        non debitis praesentium soluta aspernatur. Asperiores, laborum.
      </p>
    </section>
  );
}
